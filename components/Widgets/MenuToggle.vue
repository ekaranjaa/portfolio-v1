<template>
  ...
  >
    ...
    ></span>
    <span
      class="ml-auto my-2 h-0.5 w-4 block bg-blue-500 dark:bg-red-500 rounded-full transition duration-300"
      :class="{ hidden: menu }"
    ></span>
    <span
      class="ml-auto transform h-0.5 block bg-blue-500 dark:bg-red-500 rounded-full transition duration-300"
